...
const Services: React.FC = () => {
  return (
    <section className="py-32 bg-white dark:bg-[#111111] px-6 md:px-12 border-t border-gray-100 dark:border-gray-800" id="services">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-24 items-start mb-24">
          <div>
            ...
            <h2 className="text-6xl md:text-7xl font-serif tracking-tighter mb-8 leading-none italic dark:text-white">Technical<br />Concentration</h2>
            <p className="text-xl text-gray-500 dark:text-gray-400 font-light leading-relaxed max-w-lg">
              I apply rigorous statistical methods to software engineering challenges. My work sits at the intersection of data and human experience.
            </p>
          </div>
          ...
          <div className="grid gap-12">
            {SERVICES.map((service) => (
              <div key={service.id} className="flex gap-8 group">
                <div className="w-16 h-16 bg-gray-50 dark:bg-[#1A1A1A] rounded-2xl flex items-center justify-center shrink-0 border border-gray-100 dark:border-gray-800 group-hover:bg-orange-600 group-hover:text-white transition-all duration-500">
                  {service.icon}
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-3 tracking-tight group-hover:text-orange-600 transition-colors dark:text-white">{service.title}</h3>
        ...
        <div className="bg-gray-50 dark:bg-[#1A1A1A] rounded-3xl p-12 border border-gray-100 dark:border-gray-800 flex flex-wrap gap-x-20 gap-y-12 justify-center">
